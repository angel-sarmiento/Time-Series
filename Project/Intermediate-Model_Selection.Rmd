---
title: 'Forecasting South Florida MSA Nonfarm Employment'
...
#Plotting Predictions
autoplot(best_fc, data = data_ts[300:362,], level = c(68, 95, 99)) +
  geom_point() +
...
\begin{center}
Figure 8. Point and interval forecast for the differenced nonfarm employment in February 2020
\end{center}
...
#Plotting Predictions
autoplot(best_fc2, data = data_ts[300:362,], level = c(68, 95, 99)) +
  geom_point() +
...
\begin{center}
Figure 9. Point and Interval forecasts with the DAR model for February 2020.
\end{center}

# Forecasting Total Nonfarm Employment in March 2020
...
glmnet_pred_mar <- data.frame(rolling_net_mar['pred'])
...
# TO-DO
- Establish why im not using empirical intervals 
- Finish putting code into the appendix
- Write Report
